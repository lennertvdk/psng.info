...
const de = {
  ...
  events: {
    ...
    introBefore:
      "Vorträge, Treffen und Konferenzbesuche auf einem Zeitstrahl: links liegt, was war, rechts, was kommt. Kachel auswählen für alle Details. (Zoom-)Links zur Teilnahme gibt's über ",
    introMiddle: " und ",
    introAfter: ".",
    ...
    languageNote: {
      talk: { before: "Der Vortrag ist ", in: "auf " },
      event: { before: "Die Veranstaltung ist ", in: "auf " },
    },
    ...
    today: "heute",
    nextUp: "Als Nächstes",
    railLabel: "Zeitstrahl der Veranstaltungen",
    railPrev: "Weiter in die Vergangenheit",
    railNext: "Weiter in die Zukunft",
...
const en: Copy = {
  ...
  events: {
    ...
    title: "Events",
    introBefore:
      "Talks, meet-ups and conference visits on one timeline: what happened is to the left, what is coming to the right. Pick a card for the full details. (Zoom) links to join are shared via ",
    introMiddle: " and ",
    introAfter: ".",
    seriesNoteBefore: "Lectures:",
    seriesNoteAfter:
    ...
    languageNote: {
      talk: { before: "This talk is ", in: "in " },
      event: { before: "This event is ", in: "in " },
    },
    seriesLabel: "PSNG Lecture",
    ...
    today: "today",
    nextUp: "Up next",
    railLabel: "Timeline of events",
    railPrev: "Further into the past",
    railNext: "Further into the future",
